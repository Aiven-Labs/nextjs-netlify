          ...
          <Box.Flex flexDirection="column" gap="5">
            ...
            <Box.Flex flexDirection="column" gap="2">
              ...
              <Box.Flex justifyContent="space-between">
                ...
                <Typography.Small>{data?.favorite.favoriteRecipesCount}</Typography.Small>
              </Box.Flex>
            </Box.Flex>
            <Divider />
            ...
            <Box.Flex flexDirection="column" gap="2">
              ...
              <Box.Flex justifyContent="space-between">
                ...
                <Typography.Small>{data?.favorite.avgFavoriteServings}</Typography.Small>
              </Box.Flex>
            </Box.Flex>
            <Divider />
            ...
            <Box.Flex flexDirection="column" gap="2">
              ...
              <Box.Flex justifyContent="space-between">
                <Typography.Small>From favorite recipes</Typography.Small>
                <Typography.Small>{data?.favorite.avgFavoriteRating}</Typography.Small>
              </Box.Flex>
            </Box.Flex>
          </Box.Flex>
        </Section>
        ...
        <Section title="Cooking time statistics">
          <Box.Flex flexDirection="column" gap="5">
            ...
            <Box.Flex flexDirection="column" gap="2">
              ...
              <Box.Flex justifyContent="space-between">
                <Typography.Small>From favorite recipes</Typography.Small>
                <Typography.Small>{formatTimeMinutes(data?.favorite.avgFavoritePrepTimeMinutes)}</Typography.Small>
              </Box.Flex>
            </Box.Flex>
            <Divider />
            ...
            <Box.Flex flexDirection="column" gap="2">
              ...
              <Box.Flex justifyContent="space-between">
                <Typography.Small>From favorite recipes</Typography.Small>
                <Typography.Small>{formatTimeMinutes(data?.favorite.avgFavoriteCookTimeMinutes)}</Typography.Small>
              </Box.Flex>
            </Box.Flex>
            <Divider />
            ...
            <Box.Flex flexDirection="column" gap="2">
              ...
              <Box.Flex justifyContent="space-between">
                <Typography.Small>From favorite recipes</Typography.Small>
                <Typography.Small>{formatTimeMinutes(data?.favorite.avgFavoriteTotalTimeMinutes)}</Typography.Small>
              </Box.Flex>
            </Box.Flex>
          </Box.Flex>
        </Section>
